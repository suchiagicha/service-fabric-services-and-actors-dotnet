...
namespace Microsoft.ServiceFabric.Services.Remoting.Client
{
    ...
    using ServiceRemotingPartitionClient = Microsoft.ServiceFabric.Services.Remoting.V2.Client.ServiceRemotingPartitionClient;
#if !DotNetCoreClr
    ...
    public abstract class ServiceProxy : ProxyBase, IServiceProxy
    {
        ...
        private V1.Client.ServiceRemotingPartitionClient partitionClient;
#endif

#if !DotNetCoreClr

        internal void Initialize(ServiceProxyGeneratorWith generatorWith, V1.Client.ServiceRemotingPartitionClient client)
        {
