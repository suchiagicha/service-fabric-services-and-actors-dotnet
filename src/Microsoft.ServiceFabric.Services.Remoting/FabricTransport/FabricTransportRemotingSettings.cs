...
namespace Microsoft.ServiceFabric.Services.Remoting.FabricTransport
{
    ...
    public class FabricTransportRemotingSettings
    {
        ...
        /// <summary>
        ///     Gets or sets the operation Timeout  which governs the whole process of sending a message, including receiving a
        ///     reply message for a request/reply service operation.
        ...
        /// <remarks>
        ///     Default Value for KeepAliveTimeout Timeout is set as TimeSpan.Zero. which indicates we disable the tcp keepalive
        ///     option.
        ///     If you are using loadbalancer , you may need to configure this in order to avoid  the loadbalancer to close the
        ///     connection after certain time.
        /// </remarks>
        ...
        /// <summary>
        ///     Gets or sets the maximum size, of a queue that stores messages while they are processed for an endpoint configured
        ///     with this setting.
        /// </summary>
        /// <value>
        ///     The maximum size for a Queue that receives messages from the channel.
        /// </value>
        /// <remarks>
        ...
        /// </remarks>
        public int HeaderBufferSize { get; set; }
        ...
        /// </remarks>
        public int HeaderMaxBufferCount { get; set; }

        /// <summary>
        ///     Gets or sets the security credentials for securing the communication.
        /// </summary>
        /// <value>
        ///     The security credentials as  <see cref=" System.Fabric.SecurityCredentials" />.
        /// </value>
        /// <remarks>
        ...
        ///     Configuration File can be specified using the filePath or using the name of the configuration package specified in
        ///     the service manifest.
        ///     It will first try to load config using configPackageName. If configPackageName is not specified then try to load
        ///     from filePath.
        /// </summary>
        /// <param name="sectionName">
        ///     The name of the section within the configuration file. If not found section in configuration
        ///     file, it will throw ArgumentException.
        /// </param>
        /// <param name="filepath">
        ///     The full path of the file where the settings will be loaded from.
        ///     If not specified , it will first try to load from default Config Package"Config" , if not found then load from
        ///     Settings "ClientExeName.Settings.xml" present in Client Exe directory.
        /// </param>
        /// <param name="configPackageName">
        ///     Name of the configuration package.If its null or empty,it will check for file in
        ///     filePath.
        /// </param>
        /// <returns>The FabricTransportRemotingSettings</returns>
        /// <remarks>
        ///     The following are the parameter names that should be provided in the configuration file, to be recognizable by
        ///     service fabric to load the transport settings.
        ...
        /// </param>
        /// <param name="configPackageName">
        ///     The name of the configuration package. If its null or empty, it will check for file in
        ///     filePath.
        /// </param>
        /// <param name="settings">
        ///     When this method returns it sets the <see cref="FabricTransportRemotingSettings" /> settings if
        ///     load from Config succeeded. If fails, its sets settings to null.
        /// </param>
        /// <returns>
        ///     <see cref="bool" /> specifies whether the settings get loaded successfully from Config.
        ...
        public static bool TryLoadFrom(
            string sectionName, out FabricTransportRemotingSettings settings,
        ...
        /// <summary>
        ///     Returns the default Settings. Loads the configuration file from default Config Package"Config", if not found then
        ///     try to load from  default config file "ClientExeName.Settings.xml"  from Client Exe directory.
        /// </summary>
        /// <param name="sectionName">
        ///     The name of the section within the configuration file. If not found section in configuration
