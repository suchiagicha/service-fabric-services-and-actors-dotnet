...
namespace Microsoft.ServiceFabric.Services.Remoting.FabricTransport.Runtime
{
    ...
    public class FabricTransportRemotingListenerSettings
    {
        ...
        /// <summary>
        ///     EndpointResourceName is name of the endpoint resource specified in ServiceManifest .This is used to obtain the port
        ///     number on which to
        ///     service will listen.
        /// </summary>
        /// <value>
        ...
        /// </value>
        /// <remarks>
        ///     Default value of EndpointResourceName  is "ServiceEndpoint"
        /// </remarks>
        ...
        /// <summary>
        ///     Operation Timeout  which governs the whole process of sending a message, including receiving a reply message for a
        ///     request/reply service operation.
        ...
        /// <summary>
        ///     MaxMessageSize represents  the maximum size for a message that can be received on a channel configured with this
        ///     setting.
        /// </summary>
        /// <value>
        ...
        /// <summary>
        ///     The maximum size, of a queue that stores messages while they are processed for an endpoint configured with this
        ///     setting.
        /// </summary>
        /// <value>
        ///     Max Size for a Queue that receives messages from the channel
        /// </value>
        /// <remarks>
        ...
        /// </summary>
        /// <value>
        ///     SecurityCredentials as  <see cref=" System.Fabric.SecurityCredentials" />
        /// </value>
        /// <remarks>
        ...
        ///     Name of the section within the configuration file. if not found , it throws
        ///     ArgumentException.
        /// </param>
        /// <param name="configPackageName">
        ///     Name of the configuration package. if not found Settings.xml in the configuration package path, it throws
        ///     ArgumentException.
        ///     If not specified, default name is "Config"
        /// </param>
        ...
        /// <summary>
        ///     Try to load the FabricTransport settings from a section specified in the service settings configuration file -
        ///     settings.xml
        /// </summary>
        /// <param name="sectionName">Name of the section within the configuration file. if not found , it return false</param>
        /// <param name="configPackageName">
        ///     Name of the configuration package. if not found Settings.xml in the configuration package path, it return false.
        ///     If not specified, default name is "Config"
        /// </param>
        /// <param name="remotingListenerSettings">
        ///     When this method returns it sets the
        ///     <see cref="FabricTransportRemotingListenerSettings" /> listenersettings if load from Config succeeded. If fails
        ///     ,its sets listenerSettings to null/>
        /// </param>
        /// <returns>
        ...
        /// <summary>
        ///     FabricTransportRemotingListenerSettings returns the default Settings .Loads the configuration file from default
