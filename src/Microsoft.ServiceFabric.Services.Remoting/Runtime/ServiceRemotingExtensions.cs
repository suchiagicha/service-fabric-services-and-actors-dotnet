...
namespace Microsoft.ServiceFabric.Services.Remoting.Runtime
{
    ...
    public static class ServiceRemotingExtensions
    {
        ...
        ///     <typeparam name="TStatefulService">
        ///         Type constraint on the service implementation. The service implementation must
        ///         derive from <see cref="Microsoft.ServiceFabric.Services.Runtime.StatefulServiceBase" /> and implement one or
        ///         more
        ///         interfaces that derive from <see cref="Microsoft.ServiceFabric.Services.Remoting.IService" /> interface.
        ///     </typeparam>
        /// </summary>
        /// <param name="serviceImplementation">A stateful service implementation.</param>
        /// <returns>
        ///     A <see cref="IServiceRemotingListener" /> communication
        ///     listener that remotes the interfaces deriving from
        ///     <see cref="Microsoft.ServiceFabric.Services.Remoting.IService" /> interface.
        /// </returns>
...

        {
            ...
            if (provider.RemotingListener.Equals(RemotingListener.V2Listener))
            {
                return new[]
                {
                    new ServiceReplicaListener(
                        t => { return provider.CreateServiceRemotingListenerV2(serviceImplementation.Context, impl); },
            ...
            if (provider.RemotingListener.Equals(RemotingListener.CompatListener))
            {
                ...
                {
                    new ServiceReplicaListener(
                        t => { return provider.CreateServiceRemotingListener(serviceImplementation.Context, impl); }
                    ),
                    new ServiceReplicaListener(
                        t => { return provider.CreateServiceRemotingListenerV2(serviceImplementation.Context, impl); },
                        ServiceRemotingProviderAttribute.DefaultV2listenerName
        ...
        /// </summary>
        /// <typeparam name="TStatelessService">
        ///     Type constraint on the service implementation. The service implementation must
        ...
        /// <summary>
        ///     An extension method that creates an <see cref="IServiceRemotingListener" />
        ///     for a stateful service implementation. This is deprecated implementation. Use this Api
        ///     CreateServiceRemotingReplicaListeners instead
        /// </summary>
        /// <typeparam name="TStatefulService">
        ///     Type constraint on the service implementation. The service implementation must
        ...
        /// <summary>
        ///     An extension method that creates an <see cref="IServiceRemotingListener" />
        ///     for a stateless service implementation. This is deprecated implementation. Use
        ///     CreateServiceRemotingInstanceListeners Api instead.
        /// </summary>
        /// <typeparam name="TStatelessService">
        ///     Type constraint on the service implementation. The service implementation must
        ///     derive from <see cref="System.Fabric.Query.StatelessService" /> and implement one or more
