...
namespace Microsoft.ServiceFabric.Services.Remoting.V1.Builder
{
    ...
    public abstract class MethodDispatcherBaseWithSerializer : MethodDispatcherBase
    {
        ...
        /// <summary>
        ///     This method is implemented by the generated method dispatcher to create the response from the specified return
        ///     value
        ...
        /// <summary>
        ///     This method is implemented by the generated method dispatcher to dispatch one way messages to the specified
        ///     methodId of the
        ///     interface implemented by the remoted object.
        /// </summary>
        /// <param name="methodId">Id of the method.</param>
        ...
        internal void Initialize(
            InterfaceDescription description, IReadOnlyDictionary<int, string> methodMap, IEnumerable<Type> requestBodyTypes,
