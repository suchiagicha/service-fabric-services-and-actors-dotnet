...
namespace Microsoft.ServiceFabric.Services.Remoting.V2.FabricTransport.Client
{
    ...
    internal class FabricTransportRemotingClientEventHandler : IFabricTransportClientEventHandler
    {
        ...
        {
            EventHandler<CommunicationClientEventArgs<FabricTransportServiceRemotingClient>> handlers = this.ClientConnected;
            if (handlers != null)
            {
                handlers(
                    this,
        ...
        {
            EventHandler<CommunicationClientEventArgs<FabricTransportServiceRemotingClient>> handlers = this.ClientDisconnected;
            if (handlers != null)
            {
                handlers(
                    this,
