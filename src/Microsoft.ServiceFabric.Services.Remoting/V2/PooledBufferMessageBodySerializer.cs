...
namespace Microsoft.ServiceFabric.Services.Remoting.V2
{
    ...
    /// </summary>
     class PooledBufferMessageBodySerializer<TRequest, TResponse> :
        IServiceRemotingRequestMessageBodySerializer,
        IServiceRemotingResponseMessageBodySerializer where TRequest : IServiceRemotingRequestMessageBody
