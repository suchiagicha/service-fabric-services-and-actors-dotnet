...
namespace Microsoft.ServiceFabric.Services.Communication.Wcf.Client
{
    ...
    ///                     <item>
    ///                         <description>
    ///                             <see cref="CommunicationObjectAbortedException" />
    ///                         </description>
    ///                     </item>
    ///                     <item>
    ///                         <description>
    ///                             <see cref="CommunicationObjectFaultedException" />
    ///                         </description>
    ///                     </item>
    ///                     <item>
    ///                         <description>
    ...
    ///                     <item>
    ///                         <description>
    ///                             <see cref="ChannelTerminatedException" />
    ///                         </description>
    ///                     </item>
    ///                 </list>
    ///             </description>
    ...
    ///                     <item>
    ///                         <description>
    ///                             <see cref="ServerTooBusyException" />
    ///                         </description>
    ///                     </item>
    ///                 </list>
    ///             </description>
    ...
    ///         <item>
    ///             <description>
    ///                 The following exceptions indicate mismatch in the binding or contract between the client and the
    ///                 service.
    ...
    ///                     <item>
    ///                         <description>
    ///                             <see cref="ActionNotSupportedException" />
    ///                         </description>
    ///                     </item>
    ///                     <item>
    ///                         <description>
    ///                             <see cref="AddressAccessDeniedException" />
    ///                         </description>
    ///                     </item>
    ///                     <item>
    ///                         <description>
    ...
    ///         <item>
    ///             <description>
    ///                 All other exceptions that are <see cref="CommunicationException" />, but not
    ///                 <see cref="FaultException" /> are handled by returning
    ///                 <see cref="ExceptionHandlingRetryResult" /> from the
    ///                 <see
    ///                     cref="IExceptionHandler.TryHandleException(ExceptionInformation, OperationRetrySettings, out ExceptionHandlingResult)" />
    ///                 method.
    ...
    ///                 <see cref="OperationRetrySettings.MaxRetryBackoffIntervalOnTransientErrors" />
    ///                 and <see cref="ExceptionHandlingRetryResult.MaxRetryCount" /> property is set to
    ///                 <see cref="OperationRetrySettings.DefaultMaxRetryCount" />.
    ///             </description>
    ///         </item>
    ///     </list>
    /// </remarks>
