...
namespace Microsoft.ServiceFabric.Actors
{
    ...
    /// <summary>
    ///     The ActorId represents the identity of an actor within an actor service. This is used to identify the partition of
    ///     the actor service inside which the actor will run, see <see cref="GetPartitionKey" />
    /// </summary>
    ...
    public sealed class ActorId : IEquatable<ActorId>, IComparable<ActorId>
    {
        ...
        /// </returns>
        /// <remarks>
        ///     The comparison is done based on the id if both the instances have same <see cref="ActorIdKind" />.
        ///     If <see cref="ActorIdKind" /> is different, then comparison is done based on string representation of the actor id.
        /// </remarks>
        ...
        /// <returns>
        ///     true if the <see cref="ActorIdKind" /> and id of the other parameter is the same as the
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             The actor service is always partitioned using
        ///             <see cref="System.Fabric.Description.PartitionScheme.UniformInt64Range" /> scheme. Therefore the partition
        ///             key is of <see cref="System.Int64" /> type.
        ///         </item>
        ///         <item>
        ///             The partition key is generated based on the <see cref="ActorIdKind" /> and the id value as follows:
        ///             <list type="bullet">
        ...
        /// <returns>
        ///     true if obj is a <see cref="ActorId" /> and its value is the same as this instance;
