...
namespace Microsoft.ServiceFabric.Actors
{
    ...
    /// <summary>
    ///     Exception thrown by actor runtime when runtime cannot acquire the turn based concurrency lock to dispatch the
    ///     method.
    /// </summary>
    [Serializable]
    public sealed class ActorConcurrencyLockTimeoutException : FabricException
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ActorConcurrencyLockTimeoutException" /> class with a specified error
        ///     message.
        /// </summary>
