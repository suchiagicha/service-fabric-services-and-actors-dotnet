...
namespace Microsoft.ServiceFabric.Actors
{
    ...
    /// <summary>
    ///     Exception thrown by actor runtime when reentrant call is made for an actor and its
    ///     <see cref="ActorReentrancyMode" /> is set to <see cref="ActorReentrancyMode.Disallowed" />.
    /// </summary>
    [Serializable]
    public sealed class ReentrancyModeDisallowedException : FabricException
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="ReentrancyModeDisallowedException" /> class with a specified error
        ///     message.
        /// </summary>
