...
namespace Microsoft.ServiceFabric.Actors.Runtime
{
    ...
    /// </summary>
    /// <remarks>
    ///     The StatePersistence attribute is not inherited by derived class, each Actor type must provide its StatePersistence
    ///     level,
    ...
    public sealed class StatePersistenceAttribute : Attribute
    {
        ...
        /// </summary>
        /// <value>
        ///     <see cref="Microsoft.ServiceFabric.Actors.Runtime.StatePersistence" /> representing type of state store to use
        ///     for the actor.
        /// </value>
