...
namespace Microsoft.ServiceFabric.Actors.Runtime
{
    ...
    /// <summary>
    ///     Represents a reminder registered using
    ...
    public interface IActorReminder
    {
        ...
        /// <remarks>
        ///     A value of negative one (-1) milliseconds means the reminder is not invoked. A value of zero (0) means the reminder
        ///     is invoked immediately after registration.
        /// </remarks>
        ...
        /// <remarks>
        ///     The first invocation of the reminder occurs after
        ///     <see cref="Microsoft.ServiceFabric.Actors.Runtime.IActorReminder.DueTime" />. All subsequent invocations occur at
        ///     intervals defined by this property.
        /// </remarks>
        TimeSpan Period { get; }
