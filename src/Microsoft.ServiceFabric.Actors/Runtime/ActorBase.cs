...
namespace Microsoft.ServiceFabric.Actors.Runtime
{
    ...
    public abstract class ActorBase
    {
        ...
        {
            this.Manager = actorService.ActorManager;
            this.Id = actorId;
        ...
        internal ActorConcurrencyLock ConcurrencyLock { get; }
        ...
        /// <summary>
        ///     Override this method to initialize the members, initialize state or register timers. This method is called right
        ///     after the actor is activated
        ...
        /// <summary>
        ///     Override this method to release any resources. This method is called when actor is deactivated (garbage collected
        ///     by Actor Runtime).
        ...
        ///     An <see cref="ActorMethodContext" /> describing the method that will be invoked by actor runtime after this method
        ///     finishes.
        /// </param>
        /// <returns>
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             <description>Invoking an actor interface method when a client request comes.</description>
        ///         </item>
        ///         <item>
        ///             <description>Invoking a method on <see cref="IRemindable" /> interface when a reminder fires.</description>
        ///         </item>
        ///         <item>
        ///             <description>Invoking a timer callback when timer fires.</description>
        ///         </item>
        ///     </list>
        /// </remarks>
        ...
        /// <summary>
        ///     Unregisters a reminder previously registered using
        ///     <see cref="Microsoft.ServiceFabric.Actors.Runtime.ActorBase.RegisterReminderAsync" />.
        /// </summary>
        ...
        protected Task UnregisterReminderAsync(IActorReminder reminder)
        {
            ...
            return this.Manager.UnregisterReminderAsync(reminder.Name, this.Id, true);
        }
        ...
        /// <param name="dueTime">
        ///     The amount of time to delay before invoking the reminder for the first time. Specify negative one (-1) milliseconds
        ///     to disable invocation. Specify zero (0) to invoke the reminder immediately after registration.
        /// </param>
        /// <param name="period">
        ///     The time interval between reminder invocations after the first invocation. Specify negative one (-1) milliseconds
        ///     to disable periodic invocation.
        /// </param>
        /// <returns>
        ///     A task that represents the asynchronous registration operation. The result of the task provides information about
        ///     the registered reminder and is used to unregister the reminder using
        ///     <see cref="Microsoft.ServiceFabric.Actors.Runtime.ActorBase.UnregisterReminderAsync" />.
        /// </returns>
        /// <remarks>
        ///     <para>
        ///         The class deriving from <see cref="Microsoft.ServiceFabric.Actors.Runtime.ActorBase" /> must implement
        ///         <see cref="Microsoft.ServiceFabric.Actors.Runtime.IRemindable" /> to consume reminder invocations. Multiple
        ///         reminders can be registered at any time, uniquely identified by <paramref name="reminderName" />. Existing
        ///         reminders can also be updated by calling this method again. Reminder invocations are synchronized both with
        ///         other reminders and other actor method callbacks.
        ///     </para>
        /// </remarks>
