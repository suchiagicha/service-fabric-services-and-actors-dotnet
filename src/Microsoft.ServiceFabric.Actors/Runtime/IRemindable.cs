...
namespace Microsoft.ServiceFabric.Actors.Runtime
{
    ...
    /// <summary>
    ///     Interface that actors must implement to consume reminders registered using
    ...
    public interface IRemindable
    {
        ...
        /// <remarks>
        ///     <para>
        ///         The state of this actor is saved by the actor runtime upon completion of the task returned by this method. If
        ///         an error occurs while saving the state, then all state cached by this actor's
        ///         <see cref="Microsoft.ServiceFabric.Actors.Runtime.Actor.StateManager" /> will be discarded and reloaded from
        ///         previously saved state when the next actor method or reminder invocation occurs.
        ///     </para>
        /// </remarks>
