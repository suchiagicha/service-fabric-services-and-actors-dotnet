...
namespace Microsoft.ServiceFabric.Actors.Runtime
{
    ...
    public sealed class ActorTypeInformation
    {
        ...
        /// </summary>
        /// <value>
        ///     The service name if specified using <see cref="ActorServiceAttribute" /> for actor class, null if attribute is
        ///     not used.
        /// </value>
        ...
        /// <summary>
        ///     Gets the <see cref="Microsoft.ServiceFabric.Actors.Runtime.StatePersistence" /> enum representing type of state
        ///     persistence for the actor.
        /// </summary>
        /// <value>
        ///     The <see cref="Microsoft.ServiceFabric.Actors.Runtime.StatePersistence" /> representing type of state
        ///     persistence for the actor.
        /// </value>
        ...
        /// <param name="actorTypeInformation">
        ...
        ///     <para>
        ///         2. actorType does not implement an interface deriving from <see cref="IActor" /> and is not marked as
        ///         abstract.
        ///     </para>
        ///     <para>
        ///         3. actorType implements more than one interface which derives from <see cref="IActor" />
        ///         but doesn't have <see cref="ActorServiceAttribute" />.
        ///     </para>
        /// </remarks>
        ...
        ///     <para>
        ///         When actorType does not implement an interface deriving from <see cref="IActor" />
        ///         and is not marked as abstract.
        ///     </para>
        ///     <para>
        ///         When actorType implements more than one interface which derives from <see cref="IActor" />
        ///         but doesn't have <see cref="ActorServiceAttribute" />.
        ///     </para>
        /// </exception>
...
#if !DotNetCoreClr
            var remotingserver = RemotingListener.V1Listener;
#else
