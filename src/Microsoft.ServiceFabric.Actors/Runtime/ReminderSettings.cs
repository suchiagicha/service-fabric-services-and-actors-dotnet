...
{
    /// <summary>
    ///     This class provides settings to configure the behavior of reminders. See
    ...
    public sealed class ReminderSettings
    {
        ...
        ///     By default the <see cref="Microsoft.ServiceFabric.Actors.Runtime.ReminderSettings.AutoDeleteOneTimeReminders" /> is
        ///     set to <c>true</c>.
        /// </summary>
