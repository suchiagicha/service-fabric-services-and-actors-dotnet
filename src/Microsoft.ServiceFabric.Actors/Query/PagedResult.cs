...
namespace Microsoft.ServiceFabric.Actors.Query
{
    ...
    public sealed class PagedResult<T> where T : class
    {
        ...
        ///     Default MessageSize of 4 MB with DataContract serialization can include up to 85000 items when ActorInformation
        ///     only includes ActorId.
        ...
        /// <summary>
        ///     Creates a new instance of <see cref="PagedResult{T}" /> class.
        /// </summary>
        public PagedResult()
        {
        ...
        /// </summary>
        /// <value>
        ///     An Enumerator, which supports a simple iteration over
        ///     the collection.
        /// </value>
        ...
        /// </remarks>
        /// <value>
        ///     ConinutationToken signifying if the method which returned
