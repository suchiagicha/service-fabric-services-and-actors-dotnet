...
namespace Microsoft.ServiceFabric.Actors.Diagnostics
{
    ...
    internal class PerformanceCounterProvider : IDisposable
    {
        ...
        private void OnActorRequestProcessingFinish(TimeSpan processingTime)
        {
            ...
            {
                this.actorRequestProcessingTimeCounterWriter.UpdateCounterValue(
                    (long) processingTime
                        .TotalMilliseconds);
            }
        }
        ...
        private void OnActorLockAcquired(TimeSpan lockAcquireWaitTime)
        {
            ...
            {
                this.actorLockAcquireWaitTimeCounterWriter.UpdateCounterValue(
                    (long) lockAcquireWaitTime
                        .TotalMilliseconds);
            }
        }
        ...
        private void OnActorRequestDeserializationFinish(TimeSpan deserializationTime)
        {
            ...
            {
                this.actorRequestDeserializationTimeCounterWriter.UpdateCounterValue(
        ...
        private void OnActorResponseSerializationFinish(TimeSpan serializationTime)
        {
            ...
            {
                this.actorResponseSerializationTimeCounterWriter.UpdateCounterValue(
        ...
        private void OnActorOnActivateAsyncFinish(TimeSpan onActivateAsyncTime)
        {
            ...
            {
                this.actorOnActivateAsyncTimeCounterWriter.UpdateCounterValue(
                    (long) onActivateAsyncTime
                        .TotalMilliseconds);
            }
        }
