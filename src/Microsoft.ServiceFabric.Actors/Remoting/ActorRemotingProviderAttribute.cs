...
namespace Microsoft.ServiceFabric.Actors.Remoting
{
    ...
    ///         <see cref="Services.Remoting.V1.Client.IServiceRemotingClientFactory" /> when it is not specified.
    ///     </para>
    ///     <para>
    ...
    public abstract class ActorRemotingProviderAttribute : Attribute
    {
        ...
        ///     <see cref="Services.Remoting.V1.Client.ServiceProxyFactory" /> to create a proxy for the remoted interface of the
        ///     service.
        /// </summary>
