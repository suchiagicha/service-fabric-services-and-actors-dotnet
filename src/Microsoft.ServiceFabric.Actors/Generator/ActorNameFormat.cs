...
namespace Microsoft.ServiceFabric.Actors.Generator
{
    ...
    public static class ActorNameFormat
    {
        ...
        ///     If this value is null application name is obtained from
        ///     <see cref="System.Fabric.CodePackageActivationContext.ApplicationName" />.
        /// </param>
        /// <param name="serviceName">
        ///     Name of service hosting the actor type. If this value is null then
        ///     service name is constructed using the actorInterfaceType.
        ...
        /// </exception>
        /// <remarks>
        ///     If applicationName is passed as null or empty string, an attempt is made to get application name from
        ...
        public static Uri GetFabricServiceUri(
            Type actorInterfaceType, string applicationName = null,
        ...
        /// </exception>
        /// <remarks>
        ///     Method will try to get application name from <see cref="System.Fabric.CodePackageActivationContext" />.
        ///     If the method still cannot determine application name, <see cref="System.ArgumentException" /> is thrown.
        /// </remarks>
        ...
        /// </exception>
        /// <remarks>
        ///     Method will create service name using the actorInterfaceType. If applicationUri is passed as null, an attempt is
        ///     made to get application name from
        ///     <see cref="System.Fabric.CodePackageActivationContext" />. If the method still cannot determine application name,
        ///     <see cref="System.ArgumentException" /> is thrown.
        /// </remarks>
        ...
        /// </exception>
        /// <remarks>
        ///     If applicationUri is passed as null, an attempt is made to get application name from
        ///     <see cref="System.Fabric.CodePackageActivationContext" />. If the method still cannot determine application name,
        ///     <see cref="System.ArgumentException" /> is thrown.
        /// </remarks>
        ...
        /// <remarks>
        ///     Values specified in replicator configuration section are used to configure
        ///     <see cref="System.Fabric.ReplicatorSettings" />
        ...
        /// <remarks>
        ///     Values specified in FabricTransport configuration section are used to configure
        ///     <see
        ///         cref="Microsoft.ServiceFabric.Services.Remoting.FabricTransport.Runtime.FabricTransportRemotingListenerSettings" />
        ...
        /// </returns>
        /// <remarks>
        ///     Values specified in ActorStateProvider configuration section are used to configure
        ///     <see cref="Microsoft.ServiceFabric.Actors.Runtime.IActorStateProvider" />
        /// </remarks>
        ...
        /// <remarks>
        ///     Values specified in replicator security configuration section are used to configure
        ///     <see cref="System.Fabric.ReplicatorSettings.SecurityCredentials" />
        ///     for the replication of actor state between primary and secondary replicas.
        /// </remarks>
        ...
        /// <remarks>
        ///     Values specified in local ESE configuration section are used to configure
        ///     <see cref="System.Fabric.LocalEseStoreSettings" />
        ...
        /// <remarks>
        ///     Code package name can be accessed from within a service as
        ///     <see cref="System.Fabric.CodePackageActivationContext.CodePackageName" />
        /// </remarks>
        ...
        /// <summary>
        ///     Gets the credential type name used in replicator security configuration section in configuration package for the
        ///     actor service.
        /// </summary>
        /// <param name="actorImplementationType">Type of class implementing the actor.</param>
        ...
        /// <summary>
        ///     Gets the application type name used in application manifest when creating Service Fabric Application package for
        ///     the actor.
        /// </summary>
