...
#if !DotNetCoreClr
        /// <summary>
        ///     Gets <see cref="Remoting.V1.Client.IActorServicePartitionClient" /> that this proxy is using to communicate with
        ///     the actor.
        /// </summary>
        /// <value>
...
#endif
        /// <summary>
        ///     Gets <see cref="Remoting.V2.Client.IActorServicePartitionClient" /> that this proxy is using to communicate with
        ///     the actor.
        /// </summary>
        /// <value>
