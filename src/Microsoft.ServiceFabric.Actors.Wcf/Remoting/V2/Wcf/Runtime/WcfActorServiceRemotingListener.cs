...
namespace Microsoft.ServiceFabric.Actors.Remoting.V2.Wcf.Runtime
{
    ...
    public class WcfActorServiceRemotingListener : WcfServiceRemotingListener
    {
        ...
        ///     a default listener binding is created using
        ///     <see cref="Microsoft.ServiceFabric.Services.Communication.Wcf.WcfUtility.CreateTcpListenerBinding" /> method which
        ///     creates
        ...
        public WcfActorServiceRemotingListener(
            ...
            : base(
                ...
                new ActorRemotingSerializationManager(
                    new ActorRemotingDataContractSerializationProvider(null),
        ...
        ///     WCF binding to use for the listener. If the listener binding is not specified or null,
        ///     a default listener binding is created using
        ///     <see cref="Microsoft.ServiceFabric.Services.Communication.Wcf.WcfUtility.CreateTcpListenerBinding" /> method.
        /// </param>
        /// <param name="address">
