...
namespace Microsoft.ServiceFabric.Services
{
    ...
    public static class ServiceNameFormat
    {
        ...
        ///     <list type="bullet">
        ///         <item>
        ///             If the type name is <code>IMyService</code>, this method returns <code>MyServiceEndpoint</code> as the name
        ///             of the endpoint resource.
        ///         </item>
        ///         <item>
        ///             If the type name is <code>Foo</code>, this method returns <code>FooServiceEndpoint</code> as the name of
