...
namespace Microsoft.ServiceFabric.Services.Runtime
{
    ...
    public abstract class StatefulServiceBase : IStatefulUserServiceReplica
    {
        ...
        ///     A <see cref="StatefulServiceContext" /> describes the service context, which it provides information like replica
        ///     ID, partition ID, and service name.
        /// </param>
        ...
        internal IStateProviderReplica2 StateProviderReplica { get; }
        ...
        /// <summary>
        ///     Override this method to supply the communication listeners for the service replica. The endpoints returned by the
        ...
        /// <summary>
        ///     This method is called when role of the replica is changing and it is the final step before completing
        ///     <see cref="IStatefulServiceReplica.ChangeRoleAsync" />.
        ...
        /// <summary>
        ///     This method is implemented as a processing loop and will only be called when the replica is primary with write
        ///     status.
        ...
        ///         <item>
        ///             <description>
        ///                 Service Fabric runtime does not handle all exception(s) escaping from <see cref="RunAsync" />. If an
        ///                 unhandled
        ///                 exception escapes from <see cref="RunAsync" />, then Service Fabric runtime takes following action(s):
        ///                 <list type="bullet">
        ///                     <item>
        ///                         <description>
        ///                             If a <see cref="FabricException" /> (or one of its derived exception) escapes from
        ///                             <see cref="RunAsync" />,
        ///                             Service Fabric runtime will restart this service replica. A health warning will be appear
        ///                             in Service Fabric
        ...
        ///                     <item>
        ///                         <description>
        ///                             If an <see cref="OperationCanceledException" /> escapes from <see cref="RunAsync" /> and
        ///                             Service Fabric runtime
        ///                             has requested cancellation by signaling <paramref name="cancellationToken" /> passed to
        ///                             <see cref="RunAsync" />,
        ///                             Service Fabric runtime handles this exception and considers it as graceful completion of
        ///                             <see cref="RunAsync" />.
        ///                         </description>
        ///                     </item>
        ///                     <item>
        ...
        ///                             If an <see cref="OperationCanceledException" /> escapes from <see cref="RunAsync" /> and
        ///                             Service Fabric runtime
        ///                             has NOT requested cancellation by signaling <paramref name="cancellationToken" /> passed to
        ///                             <see cref="RunAsync" />,
        ///                             the process that is hosting this service replica is brought down. This will impact all
        ///                             other service replicas
        ///                             that are hosted by the same process. The details about unhandled exceptions can be viewed
        ///                             in Windows Event Viewer.
        ///                         </description>
        ///                     </item>
        ///                     <item>
        ///                         <description>
        ///                             If an exception of any other type escapes from <see cref="RunAsync" /> then the process
        ///                             that is hosting this
        ///                             service replica is brought down. This will impact all other service replicas that are
        ///                             hosted by the
        ...
        ///     </list>
        ///     <para>
        ///         Failing to conform to these guidelines can cause fail-over, reconfiguration or upgrade of your service to get
        ///         stuck
        ...
        /// <returns>Task that represents the asynchronous backup operation.</returns>
        /// <remarks>
        ///     Boolean returned by the backupCallback indicate whether the service was able to successfully move the backup folder
        ///     to an external location.
        ///     If false is returned, BackupAsync throws InvalidOperationException with the relevant message indicating
        ///     backupCallback returned false.
