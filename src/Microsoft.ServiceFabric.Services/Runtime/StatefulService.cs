...
namespace Microsoft.ServiceFabric.Services.Runtime
{
    ...
    {
        /// <summary>
        ///     Creates a new <see cref="StatefulService" /> with default <see cref="IReliableStateManager" />:
        ///     <see cref="ReliableStateManager" />.
        /// </summary>
        /// <param name="serviceContext">
        ///     A <see cref="StatefulServiceContext" /> describes the stateful service context, which it provides information like
        ///     replica ID, partition ID, and service name.
        /// </param>
