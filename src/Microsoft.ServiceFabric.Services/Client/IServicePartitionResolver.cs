...
namespace Microsoft.ServiceFabric.Services.Client
{
    ...
    ///         Service resolution is the process of looking up the set of endpoints for the replicas in a partition. A service
    ///         partition resolver
    ...
    public interface IServicePartitionResolver
    {
        ...
        /// </param>
        /// <returns>
        ///     A <see cref="System.Threading.Tasks.Task">Task</see> that represents the outstanding service resolution operation.
        ///     The result from
        ...
        ///         on retry-able errors. This method overload is used in cases where the client knows that the resolved service
        ///         partition that it has is no longer valid.
        ///     </para>
        /// </summary>
        ...
        /// </param>
        /// <returns>
        ///     A <see cref="System.Threading.Tasks.Task">Task</see> that represents outstanding service resolution operation. The
        ///     result from
        ///     the Task is the <see cref="System.Fabric.ResolvedServicePartition" /> object, that contains the information
        ///     about the resolved service partition including the service endpoints.
        /// </returns>
