...
namespace Microsoft.ServiceFabric.Services.Communication.Runtime
{
    ...
    public sealed class ServiceReplicaListener
    {
        ...
        /// <param name="name">
        ///     Name of the communication listener. This parameter is optional, if the service has only one
        ///     communication listener
        /// </param>
        /// <param name="listenOnSecondary">
        ///     Specifies if the communication listener needs to be opened when the replica becomes
        ///     Active secondary. THis parameter is optional
        /// </param>
        ...
        /// <summary>
        ///     <para>
        ///         Gets the flag that indicates if this communication listener should be opened when the replica becomes an
        ...
        /// <value>
        ///     <para>
        ///         The flag that indicates if this communication listener should be opened when the replica is
        ///         <see cref="System.Fabric.ReplicaRole.ActiveSecondary" />.
        ///     </para>
        /// </value>
        /// <remarks>
        ///     <para>
        ///         This flag can be set when the primary replica is too busy to serve reads and writes efficiently and the
        ///         application can tolerate reading stale (but consistent) data,
        ...
        /// <remarks>
        ///     <para>
        ///         The factory method takes in a <see cref="System.Fabric.StatefulServiceContext" /> and returns communication
        ///         listener implementing
        ///         <see cref="Microsoft.ServiceFabric.Services.Communication.Runtime.ICommunicationListener" />.
        ///     </para>
        /// </remarks>
