...
namespace Microsoft.ServiceFabric.Services.Communication.Runtime
{
    ...
    public sealed class ServiceInstanceListener
    {
        ...
        /// <param name="name">
        ///     Name of the communication listener. This parameter is optional if the Stateless Service has only one
        ///     communication listener. If it is not given, the Name is set to DefaultName.
        /// </param>
        ...
        /// <remarks>
        ///     <para>
        ///         The factory method takes in a <see cref="System.Fabric.StatelessServiceContext" /> and returns communication
