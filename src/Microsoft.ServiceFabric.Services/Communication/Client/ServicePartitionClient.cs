...
namespace Microsoft.ServiceFabric.Services.Communication.Client
{
        ...
        where TCommunicationClient : ICommunicationClient
    {
        ...
        {
            this.Factory = communicationClientFactory;
        ...
        public ICommunicationClientFactory<TCommunicationClient> Factory { get; }
        ...
        /// <summary>
        ///     Invokes the given Function, retrying for exceptions thrown other than the exceptions in the
        ///     doNotRetryExceptionTypes.
        ///     For exceptions that are not in doNotRetryExceptionTypes, CommunicationClientFactory's
        ///     ReportOperationExceptionAsync() method
        ...
        private async Task<TCommunicationClient> GetCommunicationClientAsync(CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                {
                    this.communicationClient = await this.Factory.GetClientAsync(
                        this.ServiceUri,
                        this.PartitionKey,
