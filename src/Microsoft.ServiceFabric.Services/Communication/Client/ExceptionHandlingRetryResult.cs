...
namespace Microsoft.ServiceFabric.Services.Communication.Client
{
    ...
    public sealed class ExceptionHandlingRetryResult : ExceptionHandlingResult
    {
        ...
        ///     The maximum number of times the exception given in the exception parameter needs to be
        ///     retried for.
        /// </param>
        ...
        /// <param name="retryDelay">The interval to wait before retrying</param>
        /// <param name="maxRetryCount">
        ///     The maximum number of times the exception identified by the exceptionId parameter needs to
        ///     be retried for.
        /// </param>
        public ExceptionHandlingRetryResult(
            string exceptionId,
            ...
            int maxRetryCount)
        {
            ...
            this.RetryDelay = GetRetryDelay(
                isTransient ? retrySettings.MaxRetryBackoffIntervalOnTransientErrors : retrySettings.MaxRetryBackoffIntervalOnNonTransientErrors);
            this.MaxRetryCount = maxRetryCount;
        }
