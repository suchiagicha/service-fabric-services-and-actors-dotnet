...
namespace Microsoft.ServiceFabric.Services.Communication.Client
{
    ...
    /// </summary>
    public class CommunicationClientEventArgs : CommunicationClientEventArgs<ICommunicationClient>
    {
    }
    ...
    public class CommunicationClientEventArgs<TCommunicationClient> : EventArgs where TCommunicationClient : ICommunicationClient
    {
        /// <summary>
