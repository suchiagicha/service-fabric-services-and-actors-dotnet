...
namespace Microsoft.ServiceFabric.Services.Communication.Client
{
    ...
    public class OperationRetryControl
    {
        ...
        ///     By default this is the same exception as the reported exception, however in some cases the Factory may choose to
        ///     trasform the reported exception to a more meaningful exception.
        /// </summary>
