...
namespace FabActUtil
{
    ...
    internal class ToolArguments
    {
        ...
        [CommandLineArgument(
            ...
            Description =
                "The input assembly containing the compiled actor definitions. This argument is required for 'Manifest' target.",
            LongName = "in",
            ShortName = "i")]
        ...
        [CommandLineArgument(
            ...
            Description =
                "The type of the actor interface for which to generate the output. By default the output will be generated for all actors in the input assembly.",
            LongName = "actor",
            ShortName = "a")]
        ...
        [CommandLineArgument(
            CommandLineArgumentType.AtMostOnce,
            Description =
                "If true recurse to find actor types in all assemblies referenced by input assembly. By default this is false.",
            LongName = "recurse",
            ShortName = "r")]
        public bool Recurse;
        ...
        [CommandLineArgument(
            CommandLineArgumentType.AtMostOnce,
            Description =
                "The target output for the tool, by default tool generates Manifest.",
            LongName = "target",
            ShortName = "t")]
        ...
        [CommandLineArgument(
            CommandLineArgumentType.AtMostOnce,
            Description =
                "The application package directory to create/modify application manifest file in. The default is under output directory.",
        ...
        [CommandLineArgument(
            CommandLineArgumentType.AtMostOnce,
            Description =
                "The service package directory to create/modify service manifest files in. The default is under output directory.",
        ...
        [CommandLineArgument(
            CommandLineArgumentType.AtMostOnce,
            Description =
                "Optional prefix for the Service Fabric Application Package, Application Type and Application Name.",
        ...
        [CommandLineArgument(
            CommandLineArgumentType.AtMostOnce,
            Description =
                "Optional prefix for the Service Fabric Service Package.",
        ...
        [CommandLineArgument(
            CommandLineArgumentType.AtMostOnce,
            Description =
                "The version to use in the manifests. If not specified, this will be the version of the assembly.",
            LongName = "version",
            ShortName = "ver")]
